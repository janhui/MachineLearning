function [epocs] = get_best_epochs(examples, target, untrained_network)
	...
	if (size (untrained_network,1) ==1)
		untrained_network.divideParam.trainRation = 0.80;
		untrained_network.divideParam.valRatio = 0.20;
	...
	elseif size (untrained_network,1) == 6
		epochs = zeros(1,6)
		for i = 1:6	
			untrained_network{i}.divideParam.trainRation = 0.80;
			untrained_network{i}.divideParam.valRatio = 0.20;
